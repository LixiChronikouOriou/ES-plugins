...
|------|---------|---------|
| 2026-01-25 | 1.8.0 | Added Mortar Blaster Gun, Rapidfire Blaster Turret (idea and art by Kitteh), Tiny Atomic and Plasma Engines (by Arachi, with art by Kitteh), Scorpion stun gun and turret (art by Tommaso Becca), Laser Sight (idea by ghostnzshell, revival and art by Kitteh), HTS Duct-Tape (art by Kami Rapacz), and missing @2x images for the fuel shields. Adjusted stats for Heavy Blasters, updated Engineering Room. Adjusted timeline of availability for some outfits. |
