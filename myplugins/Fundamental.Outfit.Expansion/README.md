...
- Contains the ES-wide only human adaptive reactor -- Synatom's Sentinel Reactor. *Edit*: Turns out that Zoura had that idea before, but [for the Unfettered Hai](https://github.com/AvianGeneticist/Zoura-s-Outfits-Expanded/blob/main/data/hai/unfettered%20outfits.txt).
...
| Kitteh | Autocannons<br>Light/Heavy Tractors<br>Mortar Blaster | Cardboard Box |
...
| [Timeout](https://github.com/LixiChronikouOriou) | Hesperian Toolbox<br>HTS Artisan<br>HTS Crafter<br>HTS Duct-Tape<br>Hesperian Red Lager<br>Syracusia Tractor Beam<br>Etna Mining Ray | FOE |
...
|------|---------|---------|
| 2026-01-03 | 1.7.1 | Added Mortar Blaster (idea and art by Kitteh), HTS Duct-Tape (art by Kami Rapacz), and missing @2x images for the fuel shields. Adjusted stats for Heavy Blasters. |
